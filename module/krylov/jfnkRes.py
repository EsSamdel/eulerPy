from numpy import array, zeros, ones, sqrt, ravel, abs, max, dot, arange, conjugate, linalg
...
#----------------------------------------------------------
def jfnkRes(fluxName, b, U, Dt, Dx, Un, x0=None, tol=1e-5, restrt=None, maxiter=None, xtype=None, M=None, callback=None, residuals=None):
    '''
    Modified Jacobian free Newton-Krylov method :
    Here the jacobian product need Un to be compute!!!
    ...
    # Prep for method
    r = b - jacobianProductOfR(fluxName, U, x, Dt, Dx, Un)
    ...
    for outer in range(restrt):
        ...
        for inner in range(maxiter):
            ...
            v = jacobianProductOfR(fluxName, U, v, Dt, Dx, Un)
